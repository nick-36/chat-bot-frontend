...
import { SET_EDITING } from "../../Store/ChannelSlice";
import "./ChannelInner.scss";
  ...
  const MessagingHeader = () => {
    ...
    if (channel.type === "messaging") {
      return (
        <div className="team-channel-header">
          {members.map(({ user }, i) => (
            <div key={i} className="team-channel-header__user__info">
              <Avatar
                image={user.image}
    ...
    return (
      <div className="team-channel-header">
        ...
        <span onClick={() => dispatch(SET_EDITING(true))}>
